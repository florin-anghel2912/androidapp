...
public class CpuRecycler extends RecyclerView.Adapter<CpuRecycler.RecyclerHolder> {
    ...
    public CpuRecycler(Context context, String[] list) {
    ...
    @Override
    @NonNull
    public CpuRecycler.RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LinearLayout v;
    ...
    public void onBindViewHolder(@NonNull RecyclerHolder holder, final int position) {
        ...
        View.OnClickListener clk = new View.OnClickListener() {
            public void onClick(View view) {
                ...
                switch (position) {
                    case AMD_CPU:
                        ft.replace(R.id.activity, new ListFragment(AMD_CPU_LIST));
                        break;
                    case INTEL_CPU:
                        ft.replace(R.id.activity, new ListFragment(INTEL_CPU_LIST));
                        break;
                }
